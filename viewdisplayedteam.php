...
<section>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="member">
                    ...
                    <button><a href="edit_member.php?id=<?php echo $row['id']; ?>">Edit</a></button>
                    <button><a href="delete_member.php?id=<?php echo $row['id']; ?>">Delete</a></button>
                </div>
                <?php
            }
        }
    ...
    <div class="btt">
    <button ><a href="adminn.php">back</a></button>
    </div>
